			...
			<Row>
				...
				<div className="col col-12 mt-5 mb-6">
					...
					<ul>
						...
						<li>
							<b>For other purposes.</b> Next Festival will use
							your information for data analysis to identify usage
							trends or determine the effective of our marketing
							campaigns when reasonable. We will use your
							information to evaluate and improve our Service,
					...
					<ul>
						...
						<li>
							...
							Your information will be used in order to process
							payments in the event of a purchase, refund, or
